...
$html->add(new BlogEntryPage(
  ...
  implode('', array_map(
    ...
    [
      ...
      ['His kingdom triumphant', '[bible to="Daniel 2:44–45" /]', '[bible to="Luke 1:33" /]; [bible to="1 Corinthians 15:24" /]; [bible to="Revelation 11:15" /]'],
      ...
      ['Kingdom for the saints', '[bible to="Daniel 7:27" /]', '[bible to="Luke 1:33" /]; [bible to="1 Corinthians 15:24" /]; [bible to="Revelation 11:15" /]'],
      ...
      ['New heavens and a new earth', '[bible to="Isaiah 65:17–25" /]', '[bible to="2 Peter 3:13" /]; [bible to="Revelation 21:2" /]'],
      ...
      ['Preceded by a forerunner', '[bible to="Malachi 3:1" /]', '[bible to="Matthew 11:20" /]; [bible to="Mark 1:2" /]; [bible to="Luke 7:27" /]'],
