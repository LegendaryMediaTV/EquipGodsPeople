...
$html->add(new BlogEntryPage(
  ['verses' => 'Luke 16:10–13; Matthew 25:14–30'],
  ...
  new BS_Blockquote(
    ...
    new BS_Paragraph(
      null,
      'The [sc]Lord[/sc] is always TESTING, not for the sake of failure or to mock, but to see what measure of GLORY can I CARRY. What measure can I LIVE with? Because when that glory rests on a SANCTIFIED life, it ESTABLISHES it. But that SAME measure of glory on an UNSANCTIFIED life CRUSHES it. … And so the [sc]Lord[/sc] is VERY careful with what He RELEASES to people in the way of blessing. … Often times the measure of BREAKTHROUGH and JOY in life is DIRECTLY CONNECTED to what we’ve BECOME. …',
    ),
    ...
    new BS_Paragraph(
      null,
      'The FEAR of the [sc]Lord[/sc] and COMFORT of the Holy Spirit: those two issues were the two ‘gauges on the dashboard’ that they had to make sure were in the right place. …',
    ),
