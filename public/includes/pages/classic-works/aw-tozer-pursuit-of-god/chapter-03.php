...
$html->add(new BS_Banner(
  ...
  new BS_BibleLink(['to' => 'Hebrews 10:19', 'variant' => 'dark']),
));
...
$html->add(new BS_Container(
  ...
  new BS_Section(
    ...
    new BS_Paragraph(
      null,
      'Among the famous sayings of the Church fathers none is better know than Augustine’s “[i]Thou hast formed us for Thyself, and our hearts are restless till they find rest in Thee.[/i]”',
    ),

    new BS_Paragraph(
      null,
      'The great saint states here in few words the origin and interior history of the human race. God made us for Himself: that is the only explanation that satisfies the [strong]heart[/strong] of a thinking man, whatever his wild reason may say. Should faulty education and perverse reasoning lead a man to conclude otherwise, there is little that any Christian can do for him. For such a man I have no message. My appeal is addressed to those who have been previously taught in secret by the wisdom of God; I speak to thirsty hearts whose longings have been wakened by the touch of God within them, and such as they need no reasoned proof. Their restless hearts furnish all the proof they need.',
    ),

    new BS_Paragraph(
      null,
      'God formed us for Himself. The [strong]shorter catechism[/strong], “Agreed upon by the Reverend Assembly of Divines at Westminister,” as the old [strong]New-England Primer[/strong] has it, asks the ancient questions [strong]what[/strong] and [strong]why[/strong] and answers them in one short sentence hardly matched in any uninspired work. “[strong]Question[/strong]: What is the chief End of Man? [strong]Answer[/strong]: Man’s chief End is to glorify God and enjoy Him forever.” With this agree the four and twenty elders who fall on their faces to worship Him that liveth for ever and ever, saying, “[i]Thou art worthy, O Lord, to receive glory and honour and power: for thou hast created all things, and for thy pleasure they are and were created.[/i]” [[bible to="Revelation 4:11" /]]',
    ),
    ...
    new BS_Paragraph(
      null,
      'Yet who can flee from His Presence when the heaven of heavens cannot contain Him? when as the wisdom of Solomon testifies, “[i]the Spirit of the Lord filleth the world[/i]”? The omnipresence of the Lord is one thing, and is a solemn fact necessary to His perfection; the [strong]manifest[/strong] Presence is another thing altogether, and from that Presence we have fled, like Adam, to hide among the trees of the garden, or like Peter to shrink away crying, “[i]Depart from me, for I am a sinful man, O Lord.[/i]” So the life of man upon the earth is a life away from the Presence, wrenched loose from that “blissful center” which is our right and proper dwelling place, our first state which we kept not, the loss of which is the cause of our unceasing restlessness.',
    ),
    ...
    new BS_Paragraph(
      null,
      'This first comes to our notice when our restless hearts feel a yearning for the Presence of God and we say within ourselves, “I will arise and go to my Father.” That is the first step, and as the Chinese sage Lao-tze has said, “The journey of a thousand miles begins with a first step.”',
    ),

    new BS_Paragraph(
      null,
      'The interior journey of the soul from the wilds of sin into the enjoyed Presence of God is beautifully illustrated in the Old Testament tabernacle. The returning sinner first entered the outer court where he offered a blood sacrifice on the brazen altar and washed himself in the laver that stood near it.',
    ),
    ...
    new BS_Paragraph(
      null,
      'Everything in the New Testament accords with this Old Testament picture. Ransomed men need no longer pause in fear to enter the Holy of Holies.',
    ),

    new BS_Paragraph(
      null,
      '[strong]God wills that we should push on into His Presence and live our whole life there[/strong]. This is to be known to us in conscious experience. It is more than a doctrine to be held, it is a life to be enjoyed every moment of every day. This Flame of the Presence was the beating heart of the Levitical order. Without it all the appointments of the tabernacle were characters of some unknown language; they had no meaning for Israel or for us. The greatest fact of the tabernacle was that [strong]Jehovah was there[/strong]; a Presence was waiting within the veil. Similarly the Presence of God is the central fact of Christianity. At the heart of the Christian message is God Himself waiting for His redeemed children to push in to conscious awareness of His Presence. That type of Christianity which happens now to be the vogue knows this Presence only in theory. It fails to stress the Christian’s privilege of present realization.',
    ),
    ...
    new BS_Paragraph(
      null,
      'What a broad world to roam in, what a sea to swim in is this God and Father of our Lord Jesus Christ. He is [strong]eternal[/strong], which means that He antedates time and is wholly independent of it. Time began in Him and will end in Him. To it He pays no tribute and from it He suffers no change.',
    ),

    new BS_Paragraph(
      null,
      'He is [strong]immutable[/strong], which means that He has never changed and can never change in any smallest measure. To change He would need to go from better to worse or from worse to better. He cannot do either, for being perfect He cannot become more perfect, and if He were to become less perfect He would be less than God.',
    ),

    new BS_Paragraph(
      null,
      'He is [strong]omniscient[/strong], which means that He knows in one free and effortless act all matter, all spirit, all relationships, all events. He has no past and He has no future. He [strong]is[/strong], and none of the limiting and qualifying terms used of creatures can apply to Him.',
    ),

    new BS_Paragraph(
      null,
      '[strong]Love[/strong] and [strong]mercy[/strong] and [strong]righteousness[/strong] are His, and [strong]holiness[/strong] so ineffable that no comparisons or figures will avail to express it. Only fire can give even a remote conception of it. In fire He appeared at the burning bush; in the pillar of fire He dwelt through all the long wilderness journey. The fire that glowed between the wings of the cherubim in the holy place was called the “shekinah,” the Presence, through the years of Israel’s glory, and when the Old had given place to the New, He came at Pentecost as a fiery flame and rested upon each disciple.',
    ),
    ...
    new BS_Blockquote(
      ...
      new BS_Paragraph(
        null,
        'Only to sit and think of God,' . PHP_EOL,
        'Oh what a joy it is!' . PHP_EOL,
        'To think the thought, to breathe the Name;' . PHP_EOL,
        'Earth has no higher bliss.' . PHP_EOL,
        'Father of Jesus, love’s reward!' . PHP_EOL,
        'What rapture will it be,' . PHP_EOL,
        'Prostrate before Thy throne to lie,' . PHP_EOL,
    ...
    new BS_Blockquote(
      ...
      new BS_Paragraph(
        null,
        'I love Thee so, I know not how' . PHP_EOL,
        'My transports to control;' . PHP_EOL,
        'Thy love is like a burning' . PHP_EOL,
    ...
    new BS_Blockquote(
      ...
      new BS_Paragraph(
        null,
        'O Spirit, beautiful and dread!' . PHP_EOL,
        'My heart is fit to break' . PHP_EOL,
        'With love of all Thy tenderness' . PHP_EOL,
