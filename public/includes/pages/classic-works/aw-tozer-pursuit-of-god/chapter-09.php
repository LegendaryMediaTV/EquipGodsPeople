...
$html->add(new BS_Banner(
  ...
  new BS_BibleLink(['to' => 'Matthew 5:5', 'variant' => 'dark']),
));
...
$html->add(new BS_Container(
  ...
  new BS_Section(
    ...
    new BS_Paragraph(
      null,
      'In the world of men we find nothing approaching the virtues of which Jesus spoke in the opening words of the famous Sermon on the Mount. Instead of poverty of spirit we find the rankest kind of pride; instead of mourners we find pleasure seekers; instead of meekness, arrogance; instead of hunger after righteousness we hear men saying, “[i]I am rich and increased with goods and have need of nothing[/i]”; instead of mercy we find cruelty; instead of purity of heart, corrupt imaginings; instead of peacemakers we find men quarrelsome and resentful; instead of rejoicing in mistreatment we find them fighting back with every weapon at their command. Of this kind of moral stuff civilized society is composed.',
    ),
    ...
    new BS_Paragraph(
      null,
      'As was often so with Jesus, He used this word “meek” in a brief crisp sentence, and not till some time later did He go on to explain it. In the same book of Matthew He tells us more about it and applies it to our lives. “[i]Come unto me, all ye that labour and are heavy laden, and I will give you rest. Take my yoke upon you, and learn of me; for I am meek and lowly in heart: and ye shall find rest unto your souls. For my yoke is easy, and my burden is light.[/i]” [[bible to="Matthew 11:28-30" /]] Here we have two things standing in contrast to each other, a burden and a rest. The burden is not a local one, peculiar to those first hearers, but one which is borne by the whole human race. It consists not of political oppression or poverty or hard work. It is far deeper than that.',
    ),

    new BS_Paragraph(
      null,
      'It is felt by the rich as well as the poor for it is something from which wealth and idleness can never deliver us.',
    ),
