...
$html->add(new BS_Banner(
  ...
  new BS_BibleLink(['to' => 'Psalm 63:8', 'variant' => 'dark']),
));
...
$html->add(new BS_Container(
  ...
  new BS_Section(
    ...
    new BS_Paragraph(
      null,
      'We pursue God because, and only because, He has first put an urge within us that spurs us to the pursuit. “[i]No man can come to me,[/i]” said our Lord, “[i]except the Father which hath sent me draw him,[/i]” and it is by this very prevenient [strong]drawing[/strong] that God takes from us every vestige of credit for the act of coming. The impulse to pursue God originates with God, but the outworking of that impulse is our following hard after Him; and all the time we are pursuing Him we are already in His hand: “[i]Thy right hand upholdeth me.[/i]” In this divine “upholding” and human “following” there is no contradiction.',
    ),

    new BS_Paragraph(
      null,
      'All is of God, for as von Hugel teaches, [strong]God is always previous[/strong].',
    ),

    new BS_Paragraph(
      null,
      'In practice, however, (that is, where God’s previous working meets man’s present response) man must pursue God. On our part there must be positive reciprocation if this secret drawing of God is to eventuate in identifiable experience of the Divine. In the warm language of personal feeling this is stated in the [bible to="Psalm 42"]forty-second Psalm[/bible]: “[i]As the hart panteth after the waterbrooks, so panteth my soul after thee, O God. My soul thirsteth for God, for the living God: when shall I come and appear before God?[/i]” This is deep calling unto deep, and the longing heart will understand it.',
    ),
    ...
    new BS_Paragraph(
      null,
      'All social intercourse between human beings is a response of personality to personality, grading upward from the most casual brush between man and man to the fullest, most intimate communion of which the human soul is capable. Religion, so far as it is genuine, is in essence the response of created personalities to the Creating Personality, God. “[i]This is life eternal, that they might know thee, the only true God, and Jesus Christ, whom thou hast sent.[/i]” [[bible to="John 17:3" /]]',
    ),
    ...
    new BS_Blockquote(
      ...
      new BS_Paragraph(
        null,
        'Shoreless Ocean, who can sound Thee?' . PHP_EOL,
        'Thine own eternity is round Thee,' . PHP_EOL,
        'Majesty divine!',
      ),
    ),
    ...
    new BS_Blockquote(
      ...
      new BS_Paragraph(
        null,
        'We taste Thee, O Thou Living Bread,' . PHP_EOL,
        'And long to feast upon Thee still:' . PHP_EOL,
        'We drink of Thee, the Fountainhead' . PHP_EOL,
    ...
    new BS_Paragraph(
      null,
      'Moses used the fact that he knew God as an argument for knowing Him better. “[i]Now, therefore, I pray thee, if I have found grace in thy sight, show me now thy way, that I may know thee, that I may find grace in thy sight[/i]”; and from there he rose to make the daring request, “[i]I beseech thee, show me thy glory.[/i]” God was frankly pleased by this display of ardour, and the next day called Moses into the mount, and there in solemn procession made all His glory pass before him.',
    ),

    new BS_Paragraph(
      null,
      'David’s life was a torrent of spiritual desire, and his psalms ring with the cry of the seeker and the glad shout oft he finder. Paul confessed the mainspring of his life to be his burning desire after Christ. “[i]That I may know Him,[/i]” was the goal of his heart, and to this he sacrificed everything. “[i]Yea doubtless, and I count all things but loss for the excellency of the knowledge of Christ Jesus my Lord: for whom I have suffered the loss of all things, and do count them but refuse, that I may win Christ[/i]” [[bible to="Philippians 3:8" /]].',
    ),
    ...
    new BS_Paragraph(
      null,
      'In the midst of this great chill there are some, I rejoice to acknowledge, who will not be content with shallow logic. They will admit the force of the argument, and then turn away with tears to hunt some lonely place and pray, “[i]O God, show me thy glory.[/i]” They want to taste, to touch with their hearts, to see with their inner eyes the wonder that is God.',
    ),
    ...
    new BS_Paragraph(
      null,
      'Every age has its own characteristics. Right now we are in an age of religious complexity. The simplicity which is in Christ is rarely found among us.',
    ),
    ...
    new BS_Paragraph(
      null,
      'When religion has said its last word, there is little that we need other than God Himself. The evil habit of seeking [strong]God–and[/strong] effectively prevents us from finding God in full revelation. In the “and” lies our great woe. If we omit the “and”, we shall soon find God, and in Him we shall find that for which we have all our lives been secretly longing.',
    ),
