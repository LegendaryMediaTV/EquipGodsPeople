...
$html->add(new BS_Banner(
  ...
  ', containing a dialogue between “The Voice of Christ” and “The Disciple” about the importance of inner purity'
));
...
$html->add(new BS_Container(
  ...
  new BS_SectionWithHeader(
    ...
    new BS_Paragraph(
      null,
      '“I will hear what the Lord God will speak in me.” [[bible to="Psalm 85:8" /]]',
    ),
  ...
  new BS_SectionWithHeader(
    ...
    new BS_Lead(null, 'The Disciple'),

    new BS_Paragraph(
      null,
      'Speak, Lord, for Thy servant heareth.” [[bible to="1 Samuel 3:9–10" /]] “I am Thy servant. Give me understanding that I may know Thine ordinances [[bible to="Psalm 119:125" /]] … Incline my heart to Thine ordinances [[bible to="Psalm 119:36" /]] … Let Thy speech distil as the dew.” [[bible to="Deuteronomy 32:2" /]]',
    ),

    new BS_Paragraph(
      null,
      'The children of Israel once said to Moses: “Speak thou to us and we will hear thee: let not the Lord speak to us, lest we die.” [[bible to="Exodus 20:19" /]]',
    ),
    ...
    new BS_Paragraph(
      null,
      'Speak, therefore, Lord, for Your servant listens. “Thou hast the words of eternal life.” [[bible to="John 6:68" /]] Speak to me for the comfort of my soul and for the amendment of my life, for Your praise, Your glory, and Your everlasting honor.',
    ),
  ),
  ...
  new BS_SectionWithHeader(
    ...
    new BS_Lead(null, 'The Voice of Christ'),
    ...
    new BS_Paragraph(
      null,
      '“Happy is the man whom Thou admonishest, O Lord, and teachest out of Thy law, to give him peace from the days of evil,” [[bible to="Psalm 94:12–13" /]] and that he be not desolate on earth.',
    ),
    ...
    new BS_Paragraph(
      null,
      '“Be thou ashamed, O Sidon, for the sea speaketh.” [[bible to="Isaiah 23:4" /]] And if you ask why, listen to the cause: for a small gain they travel far; for eternal life many will scarcely lift a foot from the ground. They seek a petty reward, and sometimes fight shamefully in law courts for a single piece of money. They are not afraid to work day and night for a trifle or an empty promise. But, for an unchanging good, for a reward beyond estimate, for the greatest honor and for glory everlasting, it must be said to their shame that men begrudge even the least fatigue. Be ashamed, then, lazy and complaining servant, that they should be found more eager for perdition than you are for life, that they rejoice more in vanity than you in truth.',
    ),
    ...
    new BS_Lead(null, 'A Prayer for the Grace of Devotion'),
  ...
  new BS_SectionWithHeader(
    ...
    new BS_Lead(null, 'A Prayer that the Will of God Be Done'),
  ...
  new BS_SectionWithHeader(
    ...
    new BS_Lead(null, 'A Prayer Against Bad Thoughts'),
    ...
    new BS_Lead(null, 'A Prayer for Enlightening the Mind'),
  ...
  new BS_SectionWithHeader(
    ...
    new BS_Paragraph(
      null,
      'My child, I have said: “Peace I leave with you, My peace I give unto you: not as the world giveth, do I give unto you.” [[bible to="John 14:27" /]]',
    ),
  ...
  new BS_SectionWithHeader(
    ...
    new BS_Lead(null, 'A Prayer for Cleansing the Heart and Obtaining Heavenly Wisdom'),
  ...
  new BS_SectionWithHeader(
    ...
    new BS_Paragraph(
      null,
      '“I counsel thee to buy of me gold, fire-tried, that thou mayest be made rich” [[bible to="Revelation 3:18" /]] — rich in heavenly wisdom which treads underfoot all that is low. Put aside earthly wisdom, all human self-complacency.',
    ),
  ...
  new BS_SectionWithHeader(
    [
      'title' => $metadata->book->chapters[46]->title,
      'subtitle' => $metadata->book->chapters[46]->subtitle,
      'id' => $metadata->book->chapters[46]->_id,
    ],
  ...
  new BS_SectionWithHeader(
    [
      'title' => $metadata->book->chapters[47]->title,
      'subtitle' => $metadata->book->chapters[47]->subtitle,
      'id' => $metadata->book->chapters[47]->_id,
    ],
  ...
  new BS_SectionWithHeader(
    [
      'title' => $metadata->book->chapters[48]->title,
      'subtitle' => $metadata->book->chapters[48]->subtitle,
      'id' => $metadata->book->chapters[48]->_id,
    ],
  ...
  new BS_SectionWithHeader(
    [
      'title' => $metadata->book->chapters[49]->title,
      'subtitle' => $metadata->book->chapters[49]->subtitle,
      'id' => $metadata->book->chapters[49]->_id,
    ],
  ...
  new BS_SectionWithHeader(
    [
      'title' => $metadata->book->chapters[50]->title,
      'subtitle' => $metadata->book->chapters[50]->subtitle,
      'id' => $metadata->book->chapters[50]->_id,
    ],
  ...
  new BS_SectionWithHeader(
    [
      'title' => $metadata->book->chapters[51]->title,
      'subtitle' => $metadata->book->chapters[51]->subtitle,
      'id' => $metadata->book->chapters[51]->_id,
    ],
  ...
  new BS_SectionWithHeader(
    [
      'title' => $metadata->book->chapters[52]->title,
      'subtitle' => $metadata->book->chapters[52]->subtitle,
      'id' => $metadata->book->chapters[52]->_id,
    ],
    ...
    new BS_Paragraph(
      null,
      'Consider the whole world as nothing. Prefer attendance upon God to all outward occupation, for you cannot attend upon Me and at the same time take delight in external things. You must remove yourself from acquaintances and from dear friends, and keep your mind free of all temporal consolation. Thus the blessed Apostle St. Peter begs the faithful of Christ to keep themselves as strangers and pilgrims in the world. [[bible to="1 Peter 2:11" /]]',
    ),
  ...
  new BS_SectionWithHeader(
    [
      'title' => $metadata->book->chapters[53]->title,
      'subtitle' => $metadata->book->chapters[53]->subtitle,
      'id' => $metadata->book->chapters[53]->_id,
    ],
  ...
  new BS_SectionWithHeader(
    [
      'title' => $metadata->book->chapters[54]->title,
      'subtitle' => $metadata->book->chapters[54]->subtitle,
      'id' => $metadata->book->chapters[54]->_id,
    ],
  ...
  new BS_SectionWithHeader(
    [
      'title' => $metadata->book->chapters[55]->title,
      'subtitle' => $metadata->book->chapters[55]->subtitle,
      'id' => $metadata->book->chapters[55]->_id,
    ],
  ...
  new BS_SectionWithHeader(
    [
      'title' => $metadata->book->chapters[56]->title,
      'subtitle' => $metadata->book->chapters[56]->subtitle,
      'id' => $metadata->book->chapters[56]->_id,
    ],
  ...
  new BS_SectionWithHeader(
    [
      'title' => $metadata->book->chapters[57]->title,
      'subtitle' => $metadata->book->chapters[57]->subtitle,
      'id' => $metadata->book->chapters[57]->_id,
    ],
    ...
    new BS_Paragraph(
      null,
      'When the enemy puts such suggestions in your mind, therefore, or when some curious persons raise questions about them, answer with the prophet: “Thou art just, O Lord, and righteous are Thy judgments"; [[bible to="Psalm 119:137" /]] and this: “The judgments of the Lord are true and wholly righteous.” [[bible to="Psalm 19:9" /]] My judgments are to be feared, not discussed, because they are incomprehensible to the understanding of men.',
    ),
  ...
  new BS_SectionWithHeader(
    [
      'title' => $metadata->book->chapters[58]->title,
      'subtitle' => $metadata->book->chapters[58]->subtitle,
      'id' => $metadata->book->chapters[58]->_id,
    ],
